...
const AdminDashboard = () => {
  ...
  const [activeTaimport React, { useState } from 'react';
import { useAuth } from '../../contexts/AuthContext';
import { 
  FaUsers, 
  FaBriefcase, 
...
b, setActiveTab] = useState('users');
  ...
  const handleDeleteJob = (jobId) => {
    const updatedJobs = jobs.filter(job => job.id !== jobId);
    setJobs(updatedJobs);
    // Also remove from mockJobs array
  ...
  const pendingUsers = users.filter(user => !user.verified && user.userType !== 'admin');
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">{verifiedUsers.length}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <FaUserTimes className="h-6 w-6 text-yellow-400" />
                </div>
                <div className="ml-5 w-0 flex-1">
                  <dl>
            ...
            <div className="mt-3">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedUser.verified ? 'Yes' : 'No'}</p>
                </div>
